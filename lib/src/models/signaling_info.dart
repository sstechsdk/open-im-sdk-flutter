...
class SignalingTips {
  ...
  SignalingTips({this.fromUserID, this.toUserID, this.room, this.nickname, this.faceURL,this.mediaType,this.sessionType});

  SignalingTips.fromJson(Map<String, dynamic> json) {
